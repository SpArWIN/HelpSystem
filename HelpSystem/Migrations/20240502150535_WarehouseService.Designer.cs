...
namespace HelpSystem.Migrations
{
    ...
    [Migration("20240502150535_WarehouseService")]
    partial class WarehouseService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HelpSystem.Domain.Entity.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3471e5c2-43dd-4753-a637-5e4dbad68ec4"),
                            UserId = new Guid("d6013b98-bd5b-4d24-98bc-22c38813df9e")
                        });
                });
            ...
            modelBuilder.Entity("HelpSystem.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d6013b98-bd5b-4d24-98bc-22c38813df9e"),
            ...
            modelBuilder.Entity("HelpSystem.Domain.Entity.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b38c0712-2c21-4a58-ba90-28dab36a0ac4"),
                            IsFreeZing = false,
                            IsService = true,
