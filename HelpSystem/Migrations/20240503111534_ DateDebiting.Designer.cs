...
namespace HelpSystem.Migrations
{
    ...
    [Migration("20240503111534_ DateDebiting")]
    partial class DateDebiting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HelpSystem.Domain.Entity.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f9a1ded2-237f-4d1a-b8da-6a7c93b17b3f"),
                            UserId = new Guid("e0d220e5-ba50-480b-a82f-af86e52acafd")
                        });
                });
            ...
            modelBuilder.Entity("HelpSystem.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0d220e5-ba50-480b-a82f-af86e52acafd"),
            ...
            modelBuilder.Entity("HelpSystem.Domain.Entity.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a9f5e0b-38d3-428b-9091-d2d35a4baec5"),
                            IsFreeZing = false,
                            IsService = true,
